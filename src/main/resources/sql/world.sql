...
create table xxx (
	xxxno numeric(4) not null,
	ename varchar(10),
	constraint pk_xxx primary key (xxxno)
);

create table yyy (
	yyyno numeric(4) not null,
	ename varchar(10),
	constraint pk_yyy primary key (yyyno),
	constraint fk_xxx foreign key (yyyno) references xxx(xxxno)
);

insert into xxx values (200, 'xxx200');
insert into yyy values (300, 'xxx300');
